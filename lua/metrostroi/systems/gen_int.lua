...
function ParseName(str)
	...
	if string.sub(str,1,4) == "PMP[" then
		return "Train.PMP[\""..string.sub(str,5,#str-1).."\"]"
	end
...
--------------------------------------------------------------------------------
--print("Result:\n"..SRC)
local f = io.open("sys_gen_int.lua","w+")
f:write(SRC)
f:close()