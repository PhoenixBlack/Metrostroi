...
function INTERNAL_CIRCUITS.Solve(Train,Triggers)
	...
	S["10Zh-10N"] = Train.RheostatController.RKM+(1.0-Train.RRT.Value)*(1.0-Train.RUT.Value)*Train.SR1.Value
	...
	S["2Ye"] = S["2A-2G"]*Train.A2.Value*S["2Zh-2A"]*Train.LK4.Value*Train:ReadTrainWire(2)+T[2]*(1.0-Train.LK4.Value)
	S["1R"] = S["1A"]*S["1A-1R"]
	...
	S["5V"] = Train.RKR.Value*Train:ReadTrainWire(4)+T[4]*(1.0-Train.RKR.Value)
	S["5B'"] = S["5V"]*Train.LK3.Value
	S["6A"] = Train.A6.Value*Train:ReadTrainWire(6)
	S["33V"] = S["10AK"]*1*Train.RV2.Value*1*S["10AK-VAH1"]
	...
	Train.Panel.Indications["RedLightRight"] = S["F2a"]
	...
	Train.Panel.Indications["HeadLights2"] = S["F13"]
	...
	Train.Panel.Indications["V1"] = S["10/4"]
	Triggers["KSB2"](S["6Yu"])
	Train:WriteTrainWire(23,S["1-7R-29"])
	Train.Panel.Indications["RedLightLeft"] = S["F1a"]
	...
	Train.Panel.Indications["RedRP"] = S["2-7R-21"]
	return S
end