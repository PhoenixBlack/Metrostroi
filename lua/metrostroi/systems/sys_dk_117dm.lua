...
function TRAIN_SYSTEM:Think(dT)
	...
	local minimumFlux = 0.6 -- Подмагничивание при низких токах
	...
	self.E13 = 0.390 * self.RotationRate * self.MagneticFlux13
	self.E24 = 0.390 * self.RotationRate * self.MagneticFlux24
	...
	self.Moment13 = (1.0/500.0) * Train.Electric.I13 * self.MagneticFlux13
	self.Moment24 = (1.0/500.0) * Train.Electric.I24 * self.MagneticFlux24
