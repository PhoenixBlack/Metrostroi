...
function TRAIN_SYSTEM:Think(dT)
	...
	currentMagneticFlux13 = (1.0/100.0) * 300.0*(1-math.exp(-3.0*Train.Electric.Istator13/300))
	currentMagneticFlux24 = (1.0/100.0) * 300.0*(1-math.exp(-3.0*Train.Electric.Istator24/300))
	...
	self.E13 = 0.250 * self.RotationRate * self.MagneticFlux13
	self.E24 = 0.250 * self.RotationRate * self.MagneticFlux24
