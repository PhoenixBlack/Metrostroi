...
function TRAIN_SYSTEM:Think(dT)
	...
	local b = 1.2075
	local c = 0.3461
	local Is13 = Train.Electric.Istator13
	local Is24 = Train.Electric.Istator24
	...
	self.MagneticFlux13 = math.min(8.0,math.max(0.08,self.MagneticFlux13))
	self.MagneticFlux24 = math.min(8.0,math.max(0.08,self.MagneticFlux24))
	...
	local M13 = 0.2581 + 0.328*self.MagneticFlux13 + 0.385*(self.MagneticFlux13^2)
	local M24 = 0.2581 + 0.328*self.MagneticFlux24 + 0.385*(self.MagneticFlux24^2)
	self.Moment13 = S13*(b*I13 + c*(I13^2))*(1/800.0)*M13
	self.Moment24 = S24*(b*I24 + c*(I24^2))*(1/800.0)*M24
