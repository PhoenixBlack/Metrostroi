...
function TRAIN_SYSTEM:Think(dT)
	...
	local minimumFlux = 0.001 -- Set some minimum flux to simulate random fluctuation which can excite the field
	...
	currentMagneticFlux24 = math.min(8.0,math.max(minimumFlux,currentMagneticFlux24))	
	...
	self.MagneticFlux13 = currentMagneticFlux13--self.MagneticFlux13 + 32.0 * (currentMagneticFlux13 - self.MagneticFlux13) * dT
	self.MagneticFlux24 = currentMagneticFlux24--self.MagneticFlux24 + 32.0 * (currentMagneticFlux24 - self.MagneticFlux24) * dT
	...
	--print("ENG",Train.PositionSwitch.Position,self.MagneticFlux13,Train.Electric.I13,Train.Electric.Istator13,self.E13+self.E24)
	
	--print(Train.Electric.I13)
