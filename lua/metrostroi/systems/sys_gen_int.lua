...
function TRAIN_SYSTEM.SolveEzh3(Train,Triggers)
	...
	S["10AG-10AD"] = C((P == 2) or (P == 3) or (P == 4))*(1.0-Train.TR2.Value)*(1.0-Train.TR1.Value)+Train.TR1.Value*C((P == 1) or (P == 2) or (P == 4))*Train.TR2.Value
	S["10E-10AG"] = Train.LK3.Value*C(RK == 18)*C((P == 1))+S["10AG-10AD"]*(1.0-Train.LK1.Value)*S["10AP-10AD"]
	S["2A-2G"] = C((P == 2) or (P == 4))*S["2V-2G"]+C((P == 1) or (P == 3))*C((RK >= 1) and (RK <= 17))
	S["1A-1M"] = C(RK == 6)*Train.RheostatController.RKM1+C((RK >= 1) and (RK <= 5))
	S["1Zh-1G"] = C((P == 1) or (P == 3))*Train.LK2.Value*S["1E-1Yu"]*C(RK == 1)+Train.LK3.Value
	...
	S["2Ye"] = Train.A2.Value*S["2Zh-2A"]*S["2A-2G"]*Train.LK4.Value*Train:ReadTrainWire(2)+T[6]*(1.0-Train.LK4.Value)
...
function TRAIN_SYSTEM.Solve81_714(Train,Triggers)
	...
	S["10AG-10E"] = C(RK == 18)*C((P == 1))*Train.LK3.Value+S["10AP-10AD"]*S["10AG-10AD"]*(1.0-Train.LK1.Value)
