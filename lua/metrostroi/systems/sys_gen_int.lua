...
function TRAIN_SYSTEM.SolveEzh3(Train,Triggers)
	...
	S["10E-10AG"] = Train.LK3.Value*C(RK == 18)*C((P == 1))+S["10AP-10AD"]*(1.0-Train.LK1.Value)*S["10AD-10AG"]
	...
	S["2Ye"] = Train.A2.Value*Train.LK4.Value*S["2A-2G"]*S["2Zh-2A"]*Train:ReadTrainWire(2)+T[6]*(1.0-Train.LK4.Value)
